...
% Define whehter you have control, if you have it, please define it ? life a force or soomething  ? 
Control=1;
...
u=-0.2+0.5*sin(6*(tspan'));  % input data for Sindy 

u_test=-1+1*sin((tspan_test'))+3*sin(2*(tspan_test'));    % Input data per testing 
